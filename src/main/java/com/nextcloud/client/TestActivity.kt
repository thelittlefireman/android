...
class TestActivity : FileActivity(), FileFragment.ContainerActivity, SwipeRefreshLayout
.OnRefreshListener, OnEnforceableRefreshListener {
    lateinit var fragment: Fragment
    lateinit var storage: FileDataStorageManager
    ...
    override fun getStorageManager(): FileDataStorageManager {
        if (!this::storage.isInitialized) {
            ...
            val file = OCFile("/1.md")
            file.parentId = storage.getFileByEncryptedRemotePath("/").fileId
